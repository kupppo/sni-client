...
class DevicesResponse$Type extends MessageType<DevicesResponse> {
      ...
      switch (fieldNo) {
        case /* repeated DevicesResponse.Device devices */ 1:
          message.devices.push(
            DevicesResponse_Device.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.devices.length; i++) {
      DevicesResponse_Device.internalBinaryWrite(
        message.devices[i],
...
class DevicesResponse_Device$Type extends MessageType<DevicesResponse_Device> {
  constructor() {
    super('DevicesResponse.Device', [
      ...
      { no: 3, name: 'kind', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        kind: 'enum',
        repeat: 1 /*RepeatType.PACKED*/,
        T: () => ['DeviceCapability', DeviceCapability],
      },
      {
        no: 5,
        name: 'defaultAddressSpace',
        kind: 'enum',
  ...
  create(
    value?: PartialMessage<DevicesResponse_Device>
  ...
  internalBinaryWrite(
    message: DevicesResponse_Device,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* string uri = 1; */
...
class PauseEmulationResponse$Type extends MessageType<PauseEmulationResponse> {
  ...
  create(
    value?: PartialMessage<PauseEmulationResponse>
...
class PauseToggleEmulationRequest$Type extends MessageType<PauseToggleEmulationRequest> {
  ...
  create(
    value?: PartialMessage<PauseToggleEmulationRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: PauseToggleEmulationRequest
  ): PauseToggleEmulationRequest {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
 ...
 */
export const PauseToggleEmulationRequest =
  new PauseToggleEmulationRequest$Type()
// @generated message type with reflection information, may provide speed optimized methods
class PauseToggleEmulationResponse$Type extends MessageType<PauseToggleEmulationResponse> {
  ...
  create(
    value?: PartialMessage<PauseToggleEmulationResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: PauseToggleEmulationResponse
  ): PauseToggleEmulationResponse {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
 ...
 */
export const PauseToggleEmulationResponse =
  new PauseToggleEmulationResponse$Type()
// @generated message type with reflection information, may provide speed optimized methods
class DetectMemoryMappingRequest$Type extends MessageType<DetectMemoryMappingRequest> {
  constructor() {
    super('DetectMemoryMappingRequest', [
      ...
      {
        no: 2,
        name: 'fallbackMemoryMapping',
        kind: 'enum',
        opt: true,
        T: () => ['MemoryMapping', MemoryMapping],
      },
      {
        no: 3,
        name: 'romHeader00FFB0',
        kind: 'scalar',
        opt: true,
  ...
  create(
    value?: PartialMessage<DetectMemoryMappingRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: DetectMemoryMappingRequest
  ): DetectMemoryMappingRequest {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
...
class DetectMemoryMappingResponse$Type extends MessageType<DetectMemoryMappingResponse> {
  ...
  create(
    value?: PartialMessage<DetectMemoryMappingResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: DetectMemoryMappingResponse
  ): DetectMemoryMappingResponse {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
 ...
 */
export const DetectMemoryMappingResponse =
  new DetectMemoryMappingResponse$Type()
// @generated message type with reflection information, may provide speed optimized methods
class ReadMemoryRequest$Type extends MessageType<ReadMemoryRequest> {
  constructor() {
    super('ReadMemoryRequest', [
      ...
      {
        no: 2,
        name: 'requestAddressSpace',
        kind: 'enum',
        T: () => ['AddressSpace', AddressSpace],
      },
      {
        no: 4,
        name: 'requestMemoryMapping',
        kind: 'enum',
        T: () => ['MemoryMapping', MemoryMapping],
      },
...
class SingleReadMemoryRequest$Type extends MessageType<SingleReadMemoryRequest> {
  ...
  create(
    value?: PartialMessage<SingleReadMemoryRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SingleReadMemoryRequest
  ): SingleReadMemoryRequest {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ReadMemoryRequest request */ 2:
          message.request = ReadMemoryRequest.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.request
  ...
  internalBinaryWrite(
    ...
    if (message.request) {
      ReadMemoryRequest.internalBinaryWrite(
        message.request,
...
class SingleReadMemoryResponse$Type extends MessageType<SingleReadMemoryResponse> {
  ...
  create(
    value?: PartialMessage<SingleReadMemoryResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SingleReadMemoryResponse
  ): SingleReadMemoryResponse {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* ReadMemoryResponse response */ 2:
          message.response = ReadMemoryResponse.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.response
  ...
  internalBinaryWrite(
    ...
    if (message.response) {
      ReadMemoryResponse.internalBinaryWrite(
        message.response,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join()
...
class SingleWriteMemoryRequest$Type extends MessageType<SingleWriteMemoryRequest> {
  ...
  create(
    value?: PartialMessage<SingleWriteMemoryRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SingleWriteMemoryRequest
  ): SingleWriteMemoryRequest {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* WriteMemoryRequest request */ 2:
          message.request = WriteMemoryRequest.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.request
  ...
  internalBinaryWrite(
    ...
    if (message.request) {
      WriteMemoryRequest.internalBinaryWrite(
        message.request,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join()
...
class SingleWriteMemoryResponse$Type extends MessageType<SingleWriteMemoryResponse> {
  constructor() {
    super('SingleWriteMemoryResponse', [
      { no: 1, name: 'uri', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        name: 'response',
        kind: 'message',
        T: () => WriteMemoryResponse,
      },
    ])
  }
  create(
    value?: PartialMessage<SingleWriteMemoryResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SingleWriteMemoryResponse
  ): SingleWriteMemoryResponse {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* WriteMemoryResponse response */ 2:
          message.response = WriteMemoryResponse.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.response
  ...
  internalBinaryWrite(
    ...
    if (message.response) {
      WriteMemoryResponse.internalBinaryWrite(
        message.response,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join()
...
class MultiReadMemoryRequest$Type extends MessageType<MultiReadMemoryRequest> {
  ...
  create(
    value?: PartialMessage<MultiReadMemoryRequest>
      ...
      switch (fieldNo) {
        ...
        case /* repeated ReadMemoryRequest requests */ 2:
          message.requests.push(
            ReadMemoryRequest.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
...
class MultiReadMemoryResponse$Type extends MessageType<MultiReadMemoryResponse> {
  constructor() {
    super('MultiReadMemoryResponse', [
      { no: 1, name: 'uri', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        kind: 'message',
        repeat: 1 /*RepeatType.PACKED*/,
        T: () => ReadMemoryResponse,
      },
    ])
  }
  create(
    value?: PartialMessage<MultiReadMemoryResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: MultiReadMemoryResponse
  ): MultiReadMemoryResponse {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated ReadMemoryResponse responses */ 2:
          message.responses.push(
            ReadMemoryResponse.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
...
class MultiWriteMemoryRequest$Type extends MessageType<MultiWriteMemoryRequest> {
  ...
  create(
    value?: PartialMessage<MultiWriteMemoryRequest>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: MultiWriteMemoryRequest
  ): MultiWriteMemoryRequest {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated WriteMemoryRequest requests */ 2:
          message.requests.push(
            WriteMemoryRequest.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
...
class MultiWriteMemoryResponse$Type extends MessageType<MultiWriteMemoryResponse> {
  ...
  create(
    value?: PartialMessage<MultiWriteMemoryResponse>
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: MultiWriteMemoryResponse
  ): MultiWriteMemoryResponse {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated WriteMemoryResponse responses */ 2:
          message.responses.push(
            WriteMemoryResponse.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
      ...
      switch (fieldNo) {
        ...
        case /* repeated DirEntry entries */ 3:
          message.entries.push(
            DirEntry.internalBinaryRead(reader, reader.uint32(), options)
          )
          break
        default: {
          const u = options.readUnknownField
...
class NWACommandResponse$Type extends MessageType<NWACommandResponse> {
  constructor() {
    super('NWACommandResponse', [
      { no: 1, name: 'uri', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
      {
        ...
        kind: 'message',
        repeat: 1 /*RepeatType.PACKED*/,
        T: () => NWACommandResponse_NWAASCIIItem,
      },
      {
        no: 3,
        name: 'binaryReplay',
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated NWACommandResponse.NWAASCIIItem asciiReply */ 2:
          message.asciiReply.push(
            NWACommandResponse_NWAASCIIItem.internalBinaryRead(
              reader,
              reader.uint32(),
              options
            )
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.asciiReply.length; i++) {
      NWACommandResponse_NWAASCIIItem.internalBinaryWrite(
        message.asciiReply[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join()
    }
...
class NWACommandResponse_NWAASCIIItem$Type extends MessageType<NWACommandResponse_NWAASCIIItem> {
  ...
  create(
    value?: PartialMessage<NWACommandResponse_NWAASCIIItem>
  ): NWACommandResponse_NWAASCIIItem {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.item = {}
    if (value !== undefined) {
      reflectionMergePartial<NWACommandResponse_NWAASCIIItem>(
        this,
        message,
        value
      )
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: NWACommandResponse_NWAASCIIItem
  ): NWACommandResponse_NWAASCIIItem {
    const message = target ?? this.create(),
      end = reader.pos + length
    while (reader.pos < end) {
  ...
  private binaryReadMap1(
    map: NWACommandResponse_NWAASCIIItem['item'],
    reader: IBinaryReader,
    options: BinaryReadOptions
  ): void {
    let len = reader.uint32(),
      end = reader.pos + len,
      key: keyof NWACommandResponse_NWAASCIIItem['item'] | undefined,
      val: NWACommandResponse_NWAASCIIItem['item'][any] | undefined
    while (reader.pos < end) {
      const [fieldNo, wireType] = reader.tag()
      switch (fieldNo) {
        case 1:
        ...
        default:
          throw new globalThis.Error(
            'unknown map entry field for field NWACommandResponse.NWAASCIIItem.item'
          )
      }
    }
    map[key ?? ''] = val ?? ''
  ...
  internalBinaryWrite(
    message: NWACommandResponse_NWAASCIIItem,
    writer: IBinaryWriter,
    options: BinaryWriteOptions
  ): IBinaryWriter {
    /* map<string, string> item = 1; */
    for (const k of globalThis.Object.keys(message.item)) {
      writer
 ...
 */
export const NWACommandResponse_NWAASCIIItem =
  new NWACommandResponse_NWAASCIIItem$Type()
/**
...
export const DeviceControl = new ServiceType('DeviceControl', [
  {
    name: 'ResetSystem',
    options: {},
    I: ResetSystemRequest,
    O: ResetSystemResponse,
  },
  {
    name: 'ResetToMenu',
    options: {},
    I: ResetToMenuRequest,
    O: ResetToMenuResponse,
  },
  {
    name: 'PauseUnpauseEmulation',
    options: {},
    I: PauseEmulationRequest,
    O: PauseEmulationResponse,
  },
  {
    name: 'PauseToggleEmulation',
    options: {},
    I: PauseToggleEmulationRequest,
    O: PauseToggleEmulationResponse,
  },
])
/**
...
export const DeviceMemory = new ServiceType('DeviceMemory', [
  {
    name: 'MappingDetect',
    options: {},
    I: DetectMemoryMappingRequest,
    O: DetectMemoryMappingResponse,
  },
  {
    name: 'SingleRead',
    options: {},
    I: SingleReadMemoryRequest,
    O: SingleReadMemoryResponse,
  },
  {
    name: 'SingleWrite',
    options: {},
    I: SingleWriteMemoryRequest,
    O: SingleWriteMemoryResponse,
  },
  {
    name: 'MultiRead',
    options: {},
    I: MultiReadMemoryRequest,
    O: MultiReadMemoryResponse,
  },
  {
    name: 'MultiWrite',
    options: {},
    I: MultiWriteMemoryRequest,
    O: MultiWriteMemoryResponse,
  },
  {
    name: 'StreamRead',
...
export const DeviceFilesystem = new ServiceType('DeviceFilesystem', [
  {
    name: 'ReadDirectory',
    options: {},
    I: ReadDirectoryRequest,
    O: ReadDirectoryResponse,
  },
  {
    name: 'MakeDirectory',
    options: {},
    I: MakeDirectoryRequest,
    O: MakeDirectoryResponse,
  },
  {
    name: 'RemoveFile',
    options: {},
    I: RemoveFileRequest,
    O: RemoveFileResponse,
  },
  {
    name: 'RenameFile',
    options: {},
